...
\include{sections/affine_varieties}
\include{sections/affine_algebraic_groups}
\include{sections/jordan_decomposition}
\include{sections/triangulararization_results}
