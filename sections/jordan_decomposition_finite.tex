...
%   Let~$V$ be a~{\kvs} and let~$g \colon V \to V$ be an endomorphism.
...
% 
% \begin{definition}
%   An endomorphism~$g \colon V \to V$ of a~{\kvs}~$V$ is~\emph{semisimple}\index{semisimple!endomorphism} if it satisfies the equivalent conditions from \cref{characterizations of semisimple endomorphisms}.
% \end{definition}


\begin{definition}
  An endomorphism~$g \colon V \to V$ of a~{\kvs}~$V$ is \emph{semisimple}\index{semisimple!endomorphism} if it is diagonalizable.% don’t let footnote see this linebreak
...
%   Let~$g \colon V \to V$ be an endomorphism of a {\fd}~{\kvs}~$V$ (with~$k$ algebraically closed).
%   Then~$g$ is semisimple if and only if~$g$ is diagonalizable.
% \end{lemma}
% 
% 
% \begin{proof}
%   It follows from~$k$ being algebraically closed and~$V$ being {\fd} that every nonzero~\dash{$g$}{invariant} subspace~$W \subseteq V$ contains an eigenvector of~$g$, which then spans an \dash{one}{dimensional}~\dash{$g$}{invariant} subspace.
...
%   
%   It follows that~$V$ is a sum of simple~\dash{$g$}{invariant} subspaces if and only if it is spanned by eigenvectors of~$g$ as a~{\kvs}, which is what is means for~$g$ to be diagonalizable.
% \end{proof}
% 
% 
% \begin{remark}
%   The various properties of semisimple endomorphisms from \cref{properties of ss endomorphisms} can for {\fd} vector spaces also be shown by using the characterization of semisimple endomorphisms as the diagonalizable ones from \cref{ss iff diagbar for fd}.
% \end{remark}
...
% \begin{lemma}
%   If~$g_1, g_2 \colon V \to V$ are two endomorphisms of a {\fd}~{\kvs}~$V$ which commute with each other then it holds that
%   \[
...
\begin{lemma}
  ...
  Let~$g \colon V \to V$ be an endomorphism of a {\fd}~{\kvs}~$V$ and let~$W \subseteq V$ be a~\dash{$g$}{invariant} subspace.
  \begin{enumerate}
    \item
    ...
    \item
      Let~$g' \colon V' \to V'$ be another endomorphism of a {\fd}~{\kvs}~$V$ and let~$f \colon V \to V'$ be a~\dash{$k$}{linear map} with~$f \circ g = g' \circ f$, i.e.\ such that the diagram
      \begin{equation}
...
\begin{definition}
  An endomorphism~$g \colon V \to V$ of a~{\kvs}~$V$ is \emph{unipotent}\index{unipotent!endomorphism} if~$g - \id_V$ is nilpotent.
\end{definition}
...
\begin{remark}
  ...
  Note that if~$V$ is {\fd} then~$g$ is nilpotent if and only if~$0$ is the only eigenvalue of~$g$ (because~$k$ is algebraically closed) and thus~$g$ is~\dash{$\lambda$}{potent} if and only if~$\lambda$ is the only eigenvalue of~$g$.
\end{remark}
...
\begin{lemma}
  ...
  Let~$V$ be a {\fd}~{\kvs} and let~$W \subseteq V$ be a~\dash{$g$}{invariant subspace} for~$g \in \GL(V)$.
  \begin{enumerate}
    \item
    ...
    \item
      Let~$g' \in \GL(V')$ for another {\fd}~{\kvs}~$V'$ and let~$f \colon V \to V'$ be a~\dash{$k$}{linear} map with~$f \circ g = g' \circ f$, i.e.\ such that the diagram
      \begin{equation}
